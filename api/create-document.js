module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (!accessToken || !structure) return res.status(400).json({ error: 'Missing required fields: accessToken, structure' });
    ...
    return res.status(200).json({ success: true, documentId: documentId, url: `https://docs.google.com/document/d/${documentId}/edit` });
  } catch (error) {
